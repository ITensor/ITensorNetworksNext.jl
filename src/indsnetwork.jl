...
function DataGraphs.reverse_data_direction(
  ...
  is::Union{AbstractUnitRange,Tuple{Vararg{AbstractUnitRange}},Vector{<:AbstractUnitRange}},
)
  return dag(is)
end
...
@traitfn function IndsNetwork{V}(
  ...
  I = promote_type(eltype(link_space), eltype(site_space))
...
function IndsNetwork{V,I}(
  ...
  link_space::Dictionary{<:Any,<:Vector{<:AbstractUnitRange}},
  site_space::Dictionary{<:Any,<:Vector{<:AbstractUnitRange}},
) where {V,I}
...
function path_indsnetwork(external_inds::Vector{<:Vector{<:AbstractUnitRange}})
...
function path_indsnetwork(external_inds::Vector{<:AbstractUnitRange})
...
@traitfn function default_link_space(V::Type, g::::IsUnderlyingGraph)
  ...
  E = edgetype(g)
  return Dictionary{E,Vector{AbstractUnitRange}}()
end

@traitfn function default_site_space(V::Type, g::::IsUnderlyingGraph)
  return Dictionary{V,Vector{AbstractUnitRange}}()
end
...
@traitfn function link_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  linkinds::AbstractDictionary{<:Any,Vector{<:AbstractUnitRange}},
)
  E = edgetype(g)
...
@traitfn function link_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  linkinds::AbstractDictionary{<:Any,<:AbstractUnitRange},
)
...
@traitfn function link_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  link_spaces::Dictionary{<:Any,Int},
)
  return link_space_map(V, I, g, map(link_space -> [link_space], link_spaces))
end

@traitfn function link_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, link_spaces::Vector{Int}
)
...
@traitfn function link_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, link_space::Int
)
  return link_space_map(V, I, g, [link_space])
end

@traitfn function link_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, link_space::Nothing
)
...
@traitfn function link_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  link_space::AbstractDictionary{<:Any,<:Vector{<:AbstractUnitRange}},
)
  return link_space
end
...
@traitfn function site_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  siteinds::AbstractDictionary{<:Any,Vector{<:AbstractUnitRange}},
)
...
@traitfn function site_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  siteinds::AbstractDictionary{<:Any,<:AbstractUnitRange},
)
...
# `Integer` and `Vector{<:Pair{QN,<:Integer}}`.
@traitfn function site_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, site_space::Int
)
...
@traitfn function site_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, site_spaces::Vector{Int}
)
...
@traitfn function site_space_map(
  ...
  I::Type{<:AbstractUnitRange},
  g::::IsUnderlyingGraph,
  site_space::AbstractDictionary{<:Any,<:Vector{<:AbstractUnitRange}},
)
  return site_space
end

@traitfn function site_space_map(
  V::Type, I::Type{<:AbstractUnitRange}, g::::IsUnderlyingGraph, site_space::Nothing
)
