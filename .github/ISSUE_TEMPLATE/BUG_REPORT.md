---
name: ITensorNetworksNext.jl bug report
about: Create a bug report to help us improve ITensorNetworksNext.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("ITensorNetworksNext")`:
```julia
julia> using Pkg; Pkg.status("ITensorNetworksNext")
[YOUR OUTPUT HERE]
```
